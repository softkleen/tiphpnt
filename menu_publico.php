...
<body>
    ...
    <nav class="navbar navbar-expand-md navbar-fixed-top  navbar-light navbar-inverse">
        <!-- <a href="#" class="navbar-brand">Fixo</a> -->
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="menupublico">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class=""><a href="index.php#produtos" >PRODUTOS</a></li>
                    <!-- dropdown -->
                    <li class="dropdown">
